...
- صفحات إدارة مستقلة وقابلة للفتح مباشرة: البوتات، الحماية، الألعاب، الأعضاء، الأوامر، السجلات، الصلاحيات، الإعدادات، والملف الشخصي.
- جميع مؤشرات لوحة الإدارة مأخوذة من Supabase والـAgent الفعلي؛ ولا تُعرض بيانات تجريبية مكان البيانات غير المتاحة.
